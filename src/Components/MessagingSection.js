                ...
                <div className="message-con">
                    <div className="left-items">
                        <h2 className="secondary-heading">
                            We support you in five different Languages
                        </h2>
                        <p className='m-para'>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quia, dolor quis sit perferendis 
                            pariatur dolores reiciendis temporibus odit provident. Veritatis quaerat ab voluptatum accusantium obcaecati!
                        </p>
